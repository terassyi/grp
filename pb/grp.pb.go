...
var (
	file_grp_proto_rawDescOnce sync.Once
	file_grp_proto_rawDescData = file_grp_proto_rawDesc
)

func file_grp_proto_rawDescGZIP() []byte {
	file_grp_proto_rawDescOnce.Do(func() {
		file_grp_proto_rawDescData = protoimpl.X.CompressGZIP(file_grp_proto_rawDescData)
	})
...
func init() { file_grp_proto_init() }
func file_grp_proto_init() {
	if File_grp_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_grp_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_grp_proto_goTypes,
		DependencyIndexes: file_grp_proto_depIdxs,
		MessageInfos:      file_grp_proto_msgTypes,
	}.Build()
	File_grp_proto = out.File
	file_grp_proto_rawDesc = nil
	file_grp_proto_goTypes = nil
	file_grp_proto_depIdxs = nil
}
