...
var file_bgp_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x65, 0x72, 0x61, 0x73, 0x73, 0x79,
	0x69, 0x2f, 0x67, 0x72, 0x70, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_bgp_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_bgp_proto_goTypes = []interface{}{
	...
	(*NeighborInfo)(nil),         // 4: grp.NeighborInfo
	(*GetNeighborRequest)(nil),   // 5: grp.GetNeighborRequest
	(*GetNeighborResponse)(nil),  // 6: grp.GetNeighborResponse
	(*ListNeighborRequest)(nil),  // 7: grp.ListNeighborRequest
	(*ListNeighborResponse)(nil), // 8: grp.ListNeighborResponse
	(*SetASRequest)(nil),         // 9: grp.SetASRequest
	(*RemoteASRequest)(nil),      // 10: grp.RemoteASRequest
	(*RouterIdRequest)(nil),      // 11: grp.RouterIdRequest
	(*HealthRequest)(nil),        // 12: grp.HealthRequest
	(*GetLogPathRequest)(nil),    // 13: grp.GetLogPathRequest
	(*NetworkRequest)(nil),       // 14: grp.NetworkRequest
	(*empty.Empty)(nil),          // 15: google.protobuf.Empty
	(*GetLogPathResponse)(nil),   // 16: grp.GetLogPathResponse
}
var file_bgp_proto_depIdxs = []int32{
	0,  // 0: grp.GrpResult.result:type_name -> grp.ResultCode
	4,  // 1: grp.GetNeighborResponse.neighbor:type_name -> grp.NeighborInfo
	4,  // 2: grp.ListNeighborResponse.neighbors:type_name -> grp.NeighborInfo
	12, // 3: grp.BgpApi.Health:input_type -> grp.HealthRequest
	13, // 4: grp.BgpApi.GetLogPath:input_type -> grp.GetLogPathRequest
	2,  // 5: grp.BgpApi.Show:input_type -> grp.BgpShowRequest
	5,  // 6: grp.BgpApi.GetNeighbor:input_type -> grp.GetNeighborRequest
	7,  // 7: grp.BgpApi.ListNeighbor:input_type -> grp.ListNeighborRequest
	9,  // 8: grp.BgpApi.SetAS:input_type -> grp.SetASRequest
	11, // 9: grp.BgpApi.RouterId:input_type -> grp.RouterIdRequest
	10, // 10: grp.BgpApi.RemoteAS:input_type -> grp.RemoteASRequest
	14, // 11: grp.BgpApi.Network:input_type -> grp.NetworkRequest
	15, // 12: grp.BgpApi.Health:output_type -> google.protobuf.Empty
	16, // 13: grp.BgpApi.GetLogPath:output_type -> grp.GetLogPathResponse
	3,  // 14: grp.BgpApi.Show:output_type -> grp.BgpShowResponse
	6,  // 15: grp.BgpApi.GetNeighbor:output_type -> grp.GetNeighborResponse
	8,  // 16: grp.BgpApi.ListNeighbor:output_type -> grp.ListNeighborResponse
	15, // 17: grp.BgpApi.SetAS:output_type -> google.protobuf.Empty
	15, // 18: grp.BgpApi.RouterId:output_type -> google.protobuf.Empty
	15, // 19: grp.BgpApi.RemoteAS:output_type -> google.protobuf.Empty
	15, // 20: grp.BgpApi.Network:output_type -> google.protobuf.Empty
